...
import { fetchLogs, getActionJob, getSession, login, logout, postAction, saveTopologyAlias, useDashboardFeed } from "./api.js";
          ...
          <button className="chip-btn" title="Alerts" style={{ position: "relative" }}>
            ...
            {alertCount > 0 && (
              <span style={{
                ...
                borderRadius: 7, background: "var(--amber)", color: "#0a0f1c",
...
const AdGuardHero = () => {
  ...
  return (
    <div className="panel adguard-hero" style={{ background: "linear-gradient(180deg, #0f1828 0%, #131c2e 100%)" }}>
      <div className="panel-head">
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
