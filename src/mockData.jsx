...
const HISTORY = {
  ...
  containers: Array(60).fill(7).map((v, i) => i > 45 ? 8 : v),
...
const KPIS = [
  ...
  { id: "ctn",   label: "Containers",  glyph: "containerStack", value: "7/7", suffix: "",   status: "ok",   delta: "+1",    deltaTone: "up",      history: HISTORY.containers },
];
